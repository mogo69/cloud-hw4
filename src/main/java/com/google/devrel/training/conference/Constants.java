...
public class Constants {
    public static final String WEB_CLIENT_ID = "cloud-hw4";
    public static final String ANDROID_CLIENT_ID = "cloud-hw4";
    public static final String IOS_CLIENT_ID = "cloud-hw4";
